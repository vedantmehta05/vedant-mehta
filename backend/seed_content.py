"""
Initial content seed for the portfolio CMS. This mirrors the original
resumeData.js structure (minus the external `portfolio` link, per user
request) and is inserted into MongoDB only once — if the `content`
collection is empty on startup. After that, all edits happen via the
admin-only CMS API and persist in MongoDB.
"""
...
SEED_CONTENT = {
    "personal": {
        ...
        "headline": "Backend Architect & Systems Strategist — AI-Powered Infrastructure, Cloud & Blockchain",
        "tagline": "I design and build the backend systems powering AI, cloud, and blockchain products — turning complex architecture into reliable, scalable software.",
        "intro": "Python-first backend architect who thinks in systems: designing resilient, scalable infrastructure at the intersection of AI, cloud-native platforms, and blockchain — then shipping it.",
    ...
    "about": {
        "summary": [
            "Ever since I wrote my first script to automate a mundane task, I knew technology had the power to simplify the complex — and I was hooked. Today, I'm a backend architect who thinks in systems: how services talk to each other, where data should live, and how infrastructure scales under pressure.",
            "Currently at AdeptNova, I design scalable, high-performance systems that combine FastAPI, AI (LLMs and intelligent agents) and IoT — architecting platforms that enable seamless coordination between AI components, microservices, and external APIs while ensuring reliability, security, and performance.",
        ...
        "philosophy": "Technology has the power to simplify the complex. Every system I design starts with that belief — clean, scalable architecture that solves real problems, not just checks boxes.",
        "mindset": "A systems thinker's mindset: whether it's architecting a data pipeline, designing secure APIs, or aligning cross-functional teams around a technical strategy, I bring rigor, curiosity, and a bias toward shipping resilient systems.",
        "goals": "Bridging traditional backend engineering with modern AI and IoT ecosystems — delivering practical, scalable innovation at the intersection of intelligent systems and distributed infrastructure.",
        "expertiseAreas": [
    ...
    "projects": [
        {
            ...
            "company": "AdeptNova Ltd.",
            "description": "An intelligent, data-driven supply chain platform combining IoT-based asset tracking, inventory monitoring, and logistics telemetry with AI-driven demand forecasting, route optimization, and risk analysis.",
            "challenge": "Fragmented visibility across logistics, inventory, and asset data made real-time decision-making slow and reactive.",
            "solution": "Architected real-time ingestion pipelines from IoT sensors into scalable FastAPI backend services, layering AI models on top for anomaly detection and predictive insight generation.",
            "achievements": [
        ...
        },
        {
            ...
            "company": "Nextgen Clearing Ltd",
            "description": "Backend services powering a high-volume telecom clearing platform, built for reliability, security, and scale using FastAPI, PostgreSQL, and Redis.",
            "challenge": "Massive telecom datasets required low-latency processing with strict compliance and security requirements.",
            "solution": "Designed optimized storage and secure access protocols with Keycloak, layered caching with Redis, and enforced code quality through automated testing (PyTest, Mypy, Flake8).",
            "achievements": [
        ...
        },
        {
            ...
            "company": "Solvios Technology",
            "description": "An AWS-powered automation tool that transformed manual telecom billing invoice processing into a streamlined, largely automated workflow.",
            "challenge": "Manual invoice processing for telecom billing was slow, error-prone, and resource-intensive.",
            "solution": "Built a Python-based automation pipeline on AWS to parse, validate, and process invoices with minimal manual intervention.",
            "achievements": [
        ...
        },
        {
            ...
            "company": "Solvios Technology",
            "description": "A blockchain-powered marketplace enabling fractional ownership of assets through custom token issuance and smart contracts.",
            "challenge": "Traditional asset ownership models limit access — full-unit ownership creates high entry barriers for investors.",
            "solution": "Developed Solidity smart contracts and custom blockchain infrastructure to tokenize assets, enabling fractional ownership and new liquidity.",
            "achievements": [
    ...
    "certifications": [
        {"id": "python-cert", "name": "Python", "provider": "", "date": "", "skills": ["Python Programming"], "link": ""},
        {"id": "cloud-cert", "name": "Cloud Computing", "provider": "", "date": "", "skills": ["Cloud Fundamentals", "Cloud Architecture"], "link": ""},
        {"id": "redhat-cert", "name": "Red Hat System Administration", "provider": "Red Hat", "date": "", "skills": ["Linux Administration", "System Configuration"], "link": ""},
        {"id": "poolparty-2", "name": "PoolParty Course 2: Knowledge Engineering Training", "provider": "PoolParty", "date": "", "skills": ["Knowledge Engineering"], "link": ""},
        {"id": "poolparty-3", "name": "PoolParty Course 3: Semantic Integration Training", "provider": "PoolParty", "date": "", "skills": ["Semantic Integration"], "link": ""},
    ],
    "achievements": [
        {"id": "sih-2022", "title": "Finalist — Smart India Hackathon 2022", "issuer": "Government of India", "type": "Competition"},
        {"id": "yi-hackathon", "title": "YI Innovation India Hackathon 2020", "issuer": "", "type": "Competition"},
        {"id": "best-student", "title": "Best Student Awardee — 2018-2021 Batch (BSc-IT)", "issuer": "GLS University", "type": "Academic Award"},
        {"id": "special-achievement", "title": "Special Achievement Award", "issuer": "", "type": "Award"},
        {"id": "idea-presentation", "title": "Idea Presentation Recognition", "issuer": "", "type": "Recognition"},
        {"id": "code-blue", "title": "Code Blue", "issuer": "", "type": "Competition"},
    ],
}
